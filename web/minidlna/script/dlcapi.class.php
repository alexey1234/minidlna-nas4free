...
const dlc_content_generator_name 	= 'IIK-Minidlna';
		// URL of your Project
const dlc_content_generator_url = 'http://10.0.0.30:8280';
		// Cache file for save keys - you need a absolute path and a file permission 777 
const dlc_cache_keys_filename = '/mnt/data/app/minidlna/web/minidlna/jd/dlcapicache.txt';
